            ...
            >
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex items-center space-x-3">
                  ...
                  >
                    {completedSteps.includes(section.id) ? "Review" : currentStep === section.id ? "Continue" : "Start"}
                  </button>
                </div>
              </div>
                ...
                <div className="mt-6 pt-6 border-t border-gray-200 animate-fadeIn">
                  ...
                  <div className="relative py-8">
                    ...
                    <div
                      ...
                      style={{
                        height: `${Math.min(100, (currentModuleIndex / section.modules.length) * 100)}%`,
                      }}
                    ></div>
                    ...
                    <div className="relative">
                      {section.modules.map((module, moduleIndex) => {
                        const isCompleted = moduleIndex < currentModuleIndex
                      ...
                      {/* Trophy at the end */}
                      {currentModuleIndex >= section.modules.length && (
